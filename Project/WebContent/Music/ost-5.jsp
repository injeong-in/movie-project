...
<body>
	...
	<form action="./ostAction2.jsp" method="get" class="form-inline my-2 my-lg-0">
		<input type="text" name="q_search" class="form-control mr-sm-2" type="search" placeholder="내용을 입력하세요">
		...
		<div class="pads" style="width: 700px;">
			<div class="pad">
				<img name="igg" onmouseover="chImg(this,'over')"
					...
					<a>Vuelie - Christophe Beck, Frode Fjellheim</a>
				<audio id="audio" src="./MusicFile/Frozen1/1.mp3"></audio>
			...
			<div class="pad">
				<img name="igg" onmouseover="chImg2(this,'over')"
					...
					<a>Love is an open door</a>
				<audio id="audio2" src="./MusicFile/Frozen1/2.mp3"></audio>
			...
			<div class="pad">
				<img name="igg" onmouseover="chImg3(this,'over')"
					...
					<a>For the first time in forever - Kristen Bell</a>
				<audio id="audio3" src="./MusicFile/Frozen1/3.mp3"></audio>
			...
			<div class="pad">
				<img name="igg" onmouseover="chImg4(this,'over')"
					...
					<a>Let it go - Idina Menzel</a>
				<audio id="audio4" src="./MusicFile/Frozen1/4.mp3"></audio>
			...
			<div class="pad">
				<img name="igg" onmouseover="chImg5(this,'over')"
					...
					<a>Do you want to build a snow man - Kristen Bell </a>
				<audio id="audio5" src="./MusicFile/Frozen1/5.mp3"></audio>
